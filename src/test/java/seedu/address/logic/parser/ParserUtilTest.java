...
public class ParserUtilTest {
    ...
    private static final String INVALID_NRIC = "123";
    private static final String INVALID_TITLE = "!Bad";
    private static final String INVALID_DATETIME = "99-99-9999, 9999";
    ...
    private static final String VALID_TITLE = "Good";
    private static final String VALID_DATETIME = "10-10-2020, 1400";
    ...
    public void parseTags_collectionWithValidTags_returnsTagSet() throws Exception {
        ...
        Set<MedicalHistory> expectedMedicalHistorySet = new HashSet<MedicalHistory>(Arrays
                .asList(new MedicalHistory(VALID_TAG_1), new MedicalHistory(VALID_TAG_2)));
    ...
    public void parseDateTime_validValueWithoutWhitespace_returnsLocalDateTime() throws Exception {
        LocalDateTime expected = LocalDateTime.parse(VALID_DATETIME, Appointment.DATETIME_FORMAT);
        assertEquals(expected, ParserUtil.parseDateTime(VALID_DATETIME));
    }

    @Test
    public void parseDateTime_validValueWithWhitespace_returnsTrimmedLocalDateTime() throws Exception {
        String datetimeWithWhitespace = WHITESPACE + VALID_DATETIME + WHITESPACE;
        LocalDateTime expected = LocalDateTime.parse(VALID_DATETIME, Appointment.DATETIME_FORMAT);
        assertEquals(expected, ParserUtil.parseDateTime(datetimeWithWhitespace));
    }
}
